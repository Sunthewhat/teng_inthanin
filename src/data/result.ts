...
const godsDescription = {
  ...
  GARUDA:
    "GARUDA Ipsum asouhfa avn,cxpir ufiaghjvn dghoieufjdvnv ajfdgiareughfvdn nvbearugfjvndfjv ",
...
const drinksDescription = {
  โกโก้:
    "โกโก Ipsum asouhfa avn,cxpir ufiaghjvn dghoieufjdvnv ajfdgiareughfvdn nvbearugfjvndfjv ",
  อเมริกาโน่:
  ...
  ชาไทย:
    "ชาไทย Ipsum asouhfa avn,cxpir ufiaghjvn dghoieufjdvnv ajfdgiareughfvdn nvbearugfjvndfjv ",
};
